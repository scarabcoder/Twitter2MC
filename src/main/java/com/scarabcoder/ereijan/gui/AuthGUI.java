            ...
            case 3:
            	if(this.text != null){
            	   try{
             	        ...
             	        ScarabUtil.chat("Sucessfully connected to Twitter account \"" + twitter.getScreenName() + "\"!");
             	       ...
             	       try {
             	    	...
             	    	ScarabUtil.chat("Error connecting to Twitter! Try restarting Minecraft and trying again.");
